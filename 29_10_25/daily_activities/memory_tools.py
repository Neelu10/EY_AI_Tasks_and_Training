...
while True:
    ...
    elif user_input.lower().startswith("multiply"):
        try:
    ...
    # Handle Weather command
        ...
        try:
            ...
            if not city:
                print("Agent: Please specify a city. Example: weather Bengaluru")
                continue
            result = weather(city)
            print("Agent:", result)
            ...
            print("Agent: Please use 'Weather cityname' format.")
            continue

    # Default: use LLM for general queries
    else:
        try:
